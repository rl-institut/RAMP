...
HH_lunch1_soup = HH.add_appliance(1,1800,2,70,0.15,60, thermal_P_var = 0.2, pref_index =1, fixed_cycle=1)
...
HH_lunch2_rice = HH.add_appliance(1,1800,2,25,0.15,20, thermal_P_var = 0.2, pref_index = 2, fixed_cycle=1)
...
HH_lunch2_platano = HH.add_appliance(1,1800,2,10,0.15,5, thermal_P_var = 0.2, pref_index = 2, fixed_cycle=1)
...
HH_lunch3_beansnrice = HH.add_appliance(1,1800,2,45,0.2,30, thermal_P_var =0.2 , pref_index = 3, fixed_cycle=1)
...
HH_lunch_yuca = HH.add_appliance(1,1800,1,25,0.15,10, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1)
...
HH_breakfast_huminta = HH.add_appliance(1,1800,1,65,0.15,50, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1)
...
HH_breakfast_bread = HH.add_appliance(1,1800,1,15,0.15,10, thermal_P_var = 0.2, pref_index =0, fixed_cycle=1)
...
HH_breakfast_coffee = HH.add_appliance(1,1800,1,5,0.15,2, thermal_P_var = 0.2, pref_index =0)
